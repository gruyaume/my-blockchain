...
#         create_good_transactions, blockchain_network, network, mempool):
...
#         create_good_transactions, blockchain_network, node00, network, mempool):
#     blockchain_network.restart()
#     time.sleep(3)
...
#         create_good_transactions, blockchain_network, node00, node01, node02, network, mempool):
#     blockchain_network.restart()
#     time.sleep(3)
#     node00_initial_blockchain = node00.get_blockchain()
...
#         create_bad_transactions, blockchain_network, node00, network, mempool):
#     blockchain_network.restart()
